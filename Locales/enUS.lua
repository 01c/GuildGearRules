...
L["SCAN_ADDONS_DESC"] = "Check if specified AddOns are installed in the guild. Retrieves one result per argument."
...
L["SCAN_ADDONS_MESSAGE"] = "has %s installed."
L["SCAN_ADDONS_MESSAGE_NO_MATCH"] = "has no matching AddOns installed."
L["SCAN_ADDONS_MESSAGE_NOT_ALLOWED"] = "doesn't allow AddOn scanning or GGR version is too old."
